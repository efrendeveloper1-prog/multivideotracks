        ...
        <div className="flex flex-col h-screen h-[100dvh] bg-black text-white overflow-hidden font-sans">
            ...
            {isExporting && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/70 backdrop-blur-sm">
                    <div className="bg-gray-800 border border-gray-700 p-6 rounded-lg shadow-2xl w-80 text-white flex flex-col items-center">
                        ...
                        <h3 className="text-sm font-bold mb-2">Exportando Mezcla</h3>
                        <p className="text-xs text-gray-400 mb-4 text-center">{exportStatus}</p>
